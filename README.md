...
玩具熊的五夜后宫：急聘2汉化补丁
![GitHub Logo](ReadmeImage/HelpWanted2_Logo.png)
## 注意
### 本汉化补丁完全开源免费！
...
## 如何下载补丁
### 方法一：[点击下载Releases版](https://github.com/HanFengRuYue/FNAF-HelpWanted2_Chinese/releases/download/v2.1/Thumper-WindowsNoEditor_p.zip)
### 方法二：
#### 1、登录你的Github账号
...
#### 4、进入后找到最下面Artifacts里的Thumper-WindowsNoEditor_p：
...
### 4、安装完成，Help Wanted2，启动！
![Readme7](ReadmeImage/Readme7.jpg)
